 ...
 */
package io.seata.sqlparser.druid.kingbase;
 ...
 * @author yougecn
 */
public abstract class BaseKingbaseRecognizer extends BaseRecognizer {
     ...
     */
    public BaseKingbaseRecognizer(String originalSql) {
        super(originalSql);
    }
